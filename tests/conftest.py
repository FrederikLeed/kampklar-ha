...
from custom_components.kampklar.api import Activity, KampKlarApiClient, MatchVenue, User
...
@pytest.fixture
def get_match_response() -> dict:
    """Return a sample Match/GetMatch response with an invented venue."""
    return load_fixture("get_match.json")


@pytest.fixture
def mock_venue(get_match_response: dict) -> MatchVenue:
    """Return the venue parsed from the GetMatch fixture."""
    return MatchVenue.from_api(get_match_response)
